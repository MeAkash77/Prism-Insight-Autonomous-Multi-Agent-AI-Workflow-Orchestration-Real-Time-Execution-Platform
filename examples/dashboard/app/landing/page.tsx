...
function useGitHubStars() {
  ...
  useEffect(() => {
    fetch('https://github.com/MeAkash77/Prism-Insight-Autonomous-Multi-Agent-AI-Workflow-Orchestration-Real-Time-Execution-Platform.git')
      .then(res => res.json())
              ...
              <CardContent className="p-0">
                <pre className="p-6 text-sm font-mono overflow-x-auto">
                  <code className="text-zinc-400">
                    ...
                    {'\n'}
                    <span className="text-emerald-400">git clone</span> https://github.com/MeAkash77/Prism-Insight-Autonomous-Multi-Agent-AI-Workflow-Orchestration-Real-Time-Execution-Platform.git
                    {'\n'}
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              ...
              asChild
            >
              <a href="https://github.com/MeAkash77/Prism-Insight-Autonomous-Multi-Agent-AI-Workflow-Orchestration-Real-Time-Execution-Platform.git" target="_blank" rel="noopener noreferrer">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-6 text-sm text-zinc-500">
              <a
                href="https://github.com/MeAkash77/Prism-Insight-Autonomous-Multi-Agent-AI-Workflow-Orchestration-Real-Time-Execution-Platform.git"
